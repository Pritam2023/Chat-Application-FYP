...
function ChatArea({ socket }) {
  ...
  // when user select the chat then Unread messages will be cleared
  useEffect(() => {
    getMessages();
      ...
      <div className="h-[55vh] overflow-y-scroll p-5" id="messages">
        <div className="flex flex-col gap-2">
          {messages.map((message, index) => {
            //styling of messages sent by the Current user and receipent
            ...
            return (
              <div className={`flex ${isCurrentUserIsSender && "justify-end"}`}>
                ...
                {/*if Current User is Sender and message which is sent by Current user is read by receipent */}
